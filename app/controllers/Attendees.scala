...
object Attendees extends Controller {
  ...
  val viewList = views.html.Application.Attendees.list
  val viewDetails = views.html.Application.Attendees.details
  val viewCreate = views.html.Application.Attendees.create
  val viewUpdate = views.html.Application.Attendees.update
