...
object ConferenceRepository {
  ...
  private val conferenceFields = List("id", "name", "logo", "description", "start", "end", "siteUrl", "videosUrl", "tags", "venue", "location", "cfp", "tickets", "metrics", "social", "created", "createdBy")
