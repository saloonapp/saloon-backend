...
play.PlayImport.PlayKeys.routesImport ++= Seq(
  "common.models.user._",
  "common.models.event._",
  "conferences.models.ConferenceId",
  "conferences.models.PresentationId",
  "conferences.models.PersonId",
  "common.models.values.typed.ItemType",
  "common.models.values.typed.GenericId")
