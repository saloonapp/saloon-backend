...
play.PlayImport.PlayKeys.routesImport ++= Seq("common.models.user._", "common.models.event._", "common.models.values.typed.ItemType", "common.models.values.typed.GenericId")
